...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1330230240253050901";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = 'Engine Version: ${states.MainMenuState.hzEXversion} (${states.MainMenuState.psychEngineVersion})';
